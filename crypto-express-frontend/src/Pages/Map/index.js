...
import { Navbar, Sidebar, Body } from "../../Config";
import { MapCanvas } from './MapElements';
...
const index = () => {
    ...
    const mapCanvas = (canvas) => {
        ...
        let cameraOffset = { x: innerWidth / 2, y: innerHeight / 2 };
        let cameraZoom = 1;
        const MAX_ZOOM = 5;
        const MIN_ZOOM = 0.1;
    ...
    return (
        <>
            ...
            <Sidebar />
            <Body>
                <MapCanvas id="map-canvas"></MapCanvas>
            </Body>
